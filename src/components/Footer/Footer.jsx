          ...
          >
              ...
              >
                  ...
                  >
                      ...
                      >
                          Kodehash Technologies specialises in Software and
                          Mobile Development & have a deep understanding of
                          software development best practices & methodo- logies.
                  ...
                  <div style={{ width: "25%" }}>
                      ...
                      >
                          <li style={{ paddingBottom: "20px" }}>
                              Subscribe for the newsletter and receive email
                              notification of every future post.
                          </li>
                          <li style={{ paddingBottom: "20px" }}>
                              <input
                                  type="text"
                              ...
                              ></input>
                              <span style={{border: "2px solid white", padding: "7px", borderRadius: "50%"}} >
                                  <FaArrowRight
                                      style={{
                                          marginLeft: "0.4rem",
                                          color: "#00C4FF",
